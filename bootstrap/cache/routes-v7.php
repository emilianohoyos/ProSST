...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::0yNtylqLd3HCfySd',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::PdFf9MefJHYm9ahG',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::q879JNLgjc9ei8So',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::o0w6Uv4yEnQvttzS',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::fELxvHWuEl6w5Qv7',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/p(?|assword/reset/([^/]++)(*:34)|ermissions/([^/]++)(?|(*:63)|/(?|edit(*:78)|roles(?|(*:93)|/([^/]++)(*:109)))|(*:119)))|/email/verify/([^/]++)/([^/]++)(*:160)|/role(?|s/([^/]++)(?|(*:189)|/edit(*:202)|(*:210))|/([^/]++)/permissions(?|(*:243)|/([^/]++)(*:260)))|/users/([^/]++)/(?|edit(*:293)|roles(?|(*:309)|/([^/]++)(*:326))|permissions(?|(*:349)|/([^/]++)(*:366)))|/client(?|/([^/]++)(?|(*:398)|/edit(*:411)|(*:419))|\\-users(?|/([^/]++)(*:447)|\\-update/([^/]++)(*:472)))|/audit/([^/]++)(?|(*:500)|/edit(*:513)|(*:521))|/([^/]++)(*:539))/?$}sDu',
    ),
    3 => 
    array (
      34 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'permissions.roles.remove',
          ),
          1 => 
          array (
            0 => 'permission',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'users.permissions.revoke',
          ),
          1 => 
          array (
            0 => 'user',
  ...
  array (
    ...
    array (
      ...
      'uri' => 'role/{role}/permissions/{permission}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'permissions/{permission}/roles',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'permissions/{permission}/roles/{role}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\UserController@assignRoleToUser',
        'controller' => 'App\\Http\\Controllers\\Admin\\UserController@assignRoleToUser',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\UserController@removeRoleToUser',
        'controller' => 'App\\Http\\Controllers\\Admin\\UserController@removeRoleToUser',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\UserController@givePermissionToUser',
        'controller' => 'App\\Http\\Controllers\\Admin\\UserController@givePermissionToUser',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'users.permissions.give',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'users/{user}/permissions/{permission}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\UserController@revokePermissionToUser',
        'controller' => 'App\\Http\\Controllers\\Admin\\UserController@revokePermissionToUser',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'users.permissions.revoke',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ClientController@clientUserData',
        'controller' => 'App\\Http\\Controllers\\ClientController@clientUserData',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ClientController@clientUserUpdate',
        'controller' => 'App\\Http\\Controllers\\ClientController@clientUserUpdate',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'client.users.update',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'audit.show',
        'uses' => 'App\\Http\\Controllers\\AuditController@show',
        'controller' => 'App\\Http\\Controllers\\AuditController@show',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AuditController@assessment',
        'controller' => 'App\\Http\\Controllers\\AuditController@assessment',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
