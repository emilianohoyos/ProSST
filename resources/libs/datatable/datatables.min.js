 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.2.2/af-2.7.0/b-3.2.2/cr-2.0.4/date-1.5.5/fc-5.0.4/fh-4.0.1/kt-2.12.1/r-3.0.4/rg-1.5.1/rr-1.5.0/sc-2.4.3/sb-1.8.2/sp-2.3.3/sl-3.0.0/sr-1.4.1
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.2.2, AutoFill 2.7.0, Buttons 3.2.2, ColReorder 2.0.4, DateTime 1.5.5, FixedColumns 5.0.4, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.4, RowGroup 1.5.1, RowReorder 1.5.0, Scroller 2.4.3, SearchBuilder 1.8.2, SearchPanes 2.3.3, Select 3.0.0, StateRestore 1.4.1
 */
