                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                                data-bs-placement="top" title="evaluar" data-bs-toggle="modal"
                                                data-bs-target=".bs-example-modal-lg">
                                                <i class="fa fa-clipboard-check font-size-16 "></i>
                                            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>2021-02-02</td>
                                        <td>
                                            <a href="{{ route('audit.assessment') }}"
                                                class="btn btn-primary waves-effect waves-light" data-bs-placement="top"
                                                title="ver">
                                                <i class="fa fa-clipboard-check font-size-16"></i>
                                            </a>
                                            <button type="button" data-bs-placement="top" title="Editar"
