            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Toggle a working modal demo by clicking the button below. It will slide
                            down and fade in from the top of the page.</p>
                    </div><!-- end card header -->
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Another override is the option to pop up a modal that covers the user
                            viewport, available via modifier classes that are placed a <code>.modal-fullscreen</code>.</p>
                    </div><!-- end card header -->
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Modals have three optional sizes, available via modifier classes to be
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            <!-- center modal -->
                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Center modal</button>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Scrolling long content modal and You can also create a scrollable modal
                            that allows scroll the modal body by adding <code>.modal-dialog-scrollable</code> to
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div>
                                ...
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                    data-bs-toggle="modal" data-bs-target="#exampleModalLongScrollable">Long Scrollable
                                    Modal</button>
                                ...
                                <div class="modal fade" id="exampleModalLongScrollable" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongScrollableTitle">Long
                                                    Scrollable Modal</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Use <code>event.relatedTarget</code> and HTML <code>data-bs-*</code>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <!-- First modal dialog -->
                            <div class="modal fade" id="firstmodal" aria-hidden="true"
                            ...
                            <!-- Second modal dialog -->
                            <div class="modal fade" id="secondmodal" aria-hidden="true"
