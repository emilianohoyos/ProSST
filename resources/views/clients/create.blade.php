        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @section('css')
                        <!-- fullcalendar css -->
                        <link href="{{ URL::asset('build/libs/fullcalendar/main.min.css') }}" rel="stylesheet"
                            type="text/css" />
                    @endsection
                    @section('page-title')
                        Crear Usuario
                                                ...
                                                <div class="row">
                                                    <div class="col md-6">
                                                        <div class="mb-3">
                                                            <label for="headquarters" class="form-label">Sede<span
                                                                    class="text-danger">*</span></label>
                                                            <input name="headquarters" id="headquarters" type="text"
                                                                class="form-control" placeholder="Ingrese Sede" />
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input id="representative" type="representative"
                                                            ...
                                                            name="representative" value="{{ old('representative') }}"
                                                            required placeholder="Ingrese Representante">
